            ...
            mapOf(
                OpenVRHMD.OpenVRButton.Trigger to SimplePressable(
                    onPress = { _, _ ->
                        ...
                        inks =
                            stageSpaceManager.stageRoot.children.filter { it is PointCloudAblationTool.Ink || it is PathAblationTool.InkLine }
                                .mapNotNull { it as? HasSpatial }
                    ...
                    onHold = { _, _ ->
                        ...
                        if (inks.isEmpty()
                            || stageSpaceManager.hardware.hardwareDimensions()
                                .coercePosition(min + divInStageSpace, null, true) != min + divInStageSpace
                            || stageSpaceManager.hardware.hardwareDimensions()
                                .coercePosition(max + divInStageSpace, null, true) != max + divInStageSpace
                        ) {
