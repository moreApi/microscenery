...
sealed class DataAvailableSignal {
    abstract fun toProto(): org.withXR.network.v3.DataAvailableSignal
...
data class Slice(
    ...
    override fun toProto(): org.withXR.network.v3.DataAvailableSignal {
