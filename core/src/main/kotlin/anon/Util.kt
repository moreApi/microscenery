...
val MicroscenerySettings = Settings(prefix = "anon.", inputPropertiesStream = try {
    FileInputStream("anon.properties")
} catch (t: FileNotFoundException){
    System.err.println("anon.properties not found. Using default settings.")
    null
})
